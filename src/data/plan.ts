...
export const ACTIVITIES: Activity[] = [
  {
    ...
    exercises: [
      ...
      { id: "fi", name: "Flexão inclinada", xp: 15, hint: "3 × 10–12", guide: G.flexaoInclinada },
      { id: "fc", name: "Flexão comum", xp: 15, hint: "2 × 6–10", guide: G.flexaoComum },
      { id: "pp", name: "Pike push-up", xp: 15, hint: "2 × 6–8", guide: G.pikePushup },
      { id: "pl", name: "Prancha isométrica", xp: 10, hint: "3 × 20–30s", guide: G.prancha },
      { id: "db", name: "Dead bug", xp: 10, hint: "3 × 8 cada lado", guide: G.deadbug },
      { id: "au", name: "Apoio unipodal (equilíbrio)", xp: 10, hint: "3 × 20–30s", guide: G.apoioUnipodal },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "ag", name: "Agachamento livre", xp: 15, hint: "3 × 12–15", guide: G.agachamentoLivre },
      { id: "af", name: "Afundo estático", xp: 15, hint: "3 × 8 por perna", guide: G.afundoEstatico },
      { id: "gb", name: "Glute bridge", xp: 10, hint: "3 × 12", guide: G.gluteBridge },
      { id: "pt", name: "Elevação de panturrilha", xp: 10, hint: "3 × 15–20", guide: G.panturrilha },
  ...
  },
  {
    ...
    exercises: [
      { id: "aq", name: "Aquecimento padrão (10 min)", xp: 10, guide: G.aquecimento },
      { id: "rf", name: "Remada com faixa (pegada neutra)", xp: 15, hint: "3 × 10–12", guide: G.remadaFaixa },
      { id: "ra", name: "Remada australiana", xp: 15, hint: "2 × 6–8, só se sem dor", guide: G.remadaAustraliana },
      { id: "sm", name: "Superman", xp: 10, hint: "3 × 12", guide: G.superman },
      { id: "fp", name: "Face pull com faixa", xp: 10, hint: "2 × 12", guide: G.facePull },
      { id: "pl", name: "Prancha lateral", xp: 10, hint: "2 × 20s cada lado", guide: G.pranchaLateral },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "jb", name: "Jabs rápidos no ar", xp: 10, hint: "3 × 30s, leve", guide: G.jabs },
      { id: "cb", name: "Combinação lenta", xp: 10, hint: "3 × 30s", guide: G.combinacao },
      { id: "mc", name: "Mountain climbers", xp: 10, hint: "3 × 30s", guide: G.mountain },
      { id: "bp", name: "Burpees adaptado", xp: 15, hint: "2 × 30–45s", guide: G.burpee },
...
export const NEIGONG_DAILY: Activity = {
  ...
  bonusXp: 10,
  exercises: [
    { id: "zz", name: "Zhan zhuang (postura da estaca)", xp: 15, hint: "progressivo: 2–3 → 10 min", guide: G.zhanZhuang },
